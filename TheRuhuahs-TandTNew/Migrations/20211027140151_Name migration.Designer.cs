...
namespace TheRuhuahs_TandTNew.Migrations
{
    ...
    [Migration("20211027140151_Name migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheRuhuahs_TandTNew.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(4600),
                            RoleName = "SuperAdmin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(5341),
                            RoleName = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(5351),
                            RoleName = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("TheRuhuahs_TandTNew.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOfBirth = new DateTime(2021, 10, 27, 15, 1, 51, 79, DateTimeKind.Local).AddTicks(7578),
                        ...
                        new
                        {
                            ...
                            Country = "Nigeria",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(2927),
            ...
            modelBuilder.Entity("TheRuhuahs_TandTNew.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(7649),
                            RoleId = 1,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2021, 10, 27, 15, 1, 51, 83, DateTimeKind.Local).AddTicks(8066),
                            RoleId = 2,
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("TheRuhuahs_TandTNew.Models.Package", b =>
                {
                    b.HasOne("TheRuhuahs_TandTNew.Models.Trip", null)
                        .WithMany("Package")
            ...
            modelBuilder.Entity("TheRuhuahs_TandTNew.Models.Trip", b =>
                {
                    b.HasOne("TheRuhuahs_TandTNew.Models.TouristCenter", null)
                        .WithMany("Trip")
